...
`index.html#highscores` shows high scores, top earners from runners, biggest contributors, who pays whom and the most recent transactions. It shares the game’s sync data.
